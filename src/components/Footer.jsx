    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-brand">
          <img src={logo} alt="Coolest Cream" className="footer-logo" />
          <p className="footer-tagline">Handcrafted ice cream,<br />made fresh every morning in Visakhapatnam.</p>
          <p className="footer-address">
            📍 7-8-22/3/1, Harbour Park Road
Opposite Ramakrishna Mission, RK Beach
Visakhapatnam, Andhra Pradesh 530003
        ...
        <div className="footer-col">
          ...
          <div className="footer-socials">
            ...
            {/* Zomato */}
            <a href="https://zomato.com" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Zomato">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.5c1.875 0 3.375 1.5 3.375 3.375S13.875 11.25 12 11.25 8.625 9.75 8.625 7.875 10.125 4.5 12 4.5zm0 15c-3 0-5.625-1.5-7.125-3.75.375-2.25 3.375-3.75 7.125-3.75s6.75 1.5 7.125 3.75C17.625 18 15 19.5 12 19.5z"/>
              </svg>
            </a>
          </div>

          <h4 className="footer-heading mt-lg">Hours</h4>
          <p className="footer-hours">Mon – Sun<br /><strong>12:00 PM – 11:00 PM</strong></p>
        </div>
        ...
        <div className="footer-col">
          ...
          <div className="footer-payment">
            ...
            <span className="payment-pill">💵 Cash</span>
          </div>
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2026 Coolest Cream. All rights reserved. Made with 🍨 in Bangalore.</p>
      </div>
    </footer>
  );
}
